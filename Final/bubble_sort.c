...
[Bubble Sort]: Write a program to sort a given set of elements using the 
Bubble Sort method. The elements can be read from a file or can be generated 
using the random number generator. Implement the BubbleSort() procedure.
*/
#include <stdio.h>      // include standard input/output header
#include <stdlib.h>     // include standard library header
#include <time.h>       // include time header

#define n 100        // define constant n as 100
